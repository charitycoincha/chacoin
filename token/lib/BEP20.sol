...
contract BEP20 is Ownable, IBEP20 {
    ...
    /**
     * @dev Returns the address of charity part.
     */
    ...
    /**
     * @dev change the address of charity part.
     */
    function changeCharityAddress(address charityAddress_) public virtual returns (bool) {
